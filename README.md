...
<div align="center" style="display: flex">
  ...
  Meu nome é `Arthur Lessa`, tenho `19 anos` e sou de `SP/Brasil`. 
  <br> 
  
  **Formação**
  <br> 
  :books: Formado no `Instituto Federal de Educação, Ciência e Tecnologia de São Paulo – IFSP Câmpus São Paulo`
  <br>
  :book: no curso `Técnico em Informática Integrado ao Ensino Médio`
  <br> <br>
</div>
